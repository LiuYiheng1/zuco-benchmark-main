"""Minimal Baseline Comparison - Quick Version for Testing"""
import os
...
print("Minimal Baseline Comparison", flush=True)
print("="*60, flush=True)
...
methods_to_test = [
    ...
    'GaussianNB', 'KNN', 'RandomForest',
    'NearestClassMean', 'SRGC',
    'SIED', 'PCET', 'PCET_SRGC'
]
...
for seed in seeds:
    ...
    df_partial.to_csv(f"{RESULTS_DIR}/baseline_comparison_minimal.csv", index=False)
